...
_CONFIG = {
    ...
    "fast_download": False,  # Enable FastTelethon for faster downloads but higher ban risk
    "media_dir": "media",
    "media_mime_types": [],
    "proxy": {
        "enable": False,
...
def main():
    ...
    b.add_argument(
        ...
        default=["html"],
        dest="format",
        help="output format(s): html and/or json (default: html)",
    )
    b.add_argument(
        "-t",
        "--template",
    ...
    # Build static site.
        ...
        from .export_json import export_all_to_json
